...
[BASE] = LAYOUT_orthocustom(
  ...
  KC_LCTL,     KC_LGUI,     KC_LALT,    KC_LEFT,     KC_LALT,    KC_HOME,    KC_0,              KC_0,         KC_END,        KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   KC_SPACE,
                                        KC_SPACE,    KC_DEL,     KC_0,       KC_DEL,            KC_CAPS,      KC_0,          KC_BSPC,    KC_ENTER
...
[SYMB] = LAYOUT_orthocustom(
  ...
  _______,     ES_IQUE,     ES_QUES,  _______,     _______,     KC_B,                                         KC_KP_1,   KC_KP_2,     KC_KP_3,   ES_MINS,  XXXXXXX,        XXXXXXX,
  _______,     KC_LGUI,     KC_LALT,  KC_LEFT,     _______,     KC_HOME,       QK_REBOOT,       _______,      _______,   KC_0,        _______,   KC_DOT,   KC_KP_SLASH,    XXXXXXX,
                                      KC_SPACE,    KC_DEL,      KC_NUM_LOCK,   KC_DEL,          KC_TRNS,      KC_BSPC,   KC_ENTER,    KC_EQL
)
...
//[GAME] = LAYOUT_orthocustom(
  ...
  //KC_LCTL,    KC_LGUI,     KC_LALT,    KC_LEFT,     KC_RGHT,    KC_HOME,    RESET,             RESET,        KC_END,        KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   KC_SPACE,
...
//[VLR] = LAYOUT_orthocustom(
  ...
  //KC_ESC,      KC_A,        KC_S,       KC_D,        KC_F,       KC_G,       ES_LBRC,           ES_RBRC,      KC_H,          KC_J,       KC_K,       KC_L,       ES_NTIL,    ES_ACUT,
  //KC_LSFT,     KC_Z,        KC_X,       KC_C,        KC_V,       KC_B,       ZZZZZZZ,           ZZZZZZZ,      KC_N,          KC_M,       KC_COMM,    KC_DOT,     ES_MINS,    ES_GRV,
  //KC_LCTL,    KC_LGUI,     XXXXXXX,    XXXXXXX,     XXXXXXX,    KC_HOME,    TG(VLR),           XXXXXXX,      KC_END,        KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   KC_SPACE,
  //ZZZZZZZ,     ZZZZZZZ,     ZZZZZZZ,    KC_SPACE,    KC_DEL,     TG(GAME),   KC_DEL,            KC_CAPS,      KC_TRNS,      KC_BSPC,    KC_ENTER,   ZZZZZZZ,    ZZZZZZZ,    ZZZZZZZ
