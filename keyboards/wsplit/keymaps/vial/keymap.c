...
[BASE] = LAYOUT_orthocustom(
  ...
  KC_LCTRL,    KC_LGUI,     KC_LALT,    KC_LEFT,     KC_LALT,    KC_HOME,    TG(VLR),           XXXXXXX,      KC_END,        KC_LEFT,    KC_DOWN,    KC_UP,      KC_RIGHT,   XXXXXXX,
  ZZZZZZZ,     ZZZZZZZ,     ZZZZZZZ,    KC_SPACE,    KC_DEL,     TG(GAME),   KC_DEL,            KC_CAPS,      TT(SYMB),      KC_BSPC,    KC_ENTER,   ZZZZZZZ,    ZZZZZZZ,    ZZZZZZZ
